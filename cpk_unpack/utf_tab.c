...
struct utf_query_result analyze_utf(FILE *infile, const long long offset, int indent, int print, const struct utf_query *query)
{
    unsigned char buf[4];
...
struct utf_query_result query_utf(FILE *infile, const long long offset, const struct utf_query *query)
{
    return analyze_utf(infile, offset, 0, 0, query);
}

struct utf_query_result query_utf_nofail(FILE *infile, const long long offset, const struct utf_query *query)
{
...
struct utf_query_result query_utf_key(FILE *infile, const long long offset, int index, const char *name)
{
...
uint64_t query_utf_8byte(FILE *infile, const long long offset, int index, const char *name)
{
...
uint32_t query_utf_4byte(FILE *infile, const long long offset, int index, const char *name)
{
    struct utf_query_result result = query_utf_key(infile, offset, index, name);
...
uint16_t query_utf_2byte(FILE *infile, const long long offset, int index, const char *name)
{
    struct utf_query_result result = query_utf_key(infile, offset, index, name);
...
char *load_utf_string_table(FILE *infile, const long long offset)
{
    ...
    const long long string_table_offset = offset + 8 + result.string_table_offset;
...
const char *query_utf_string(FILE *infile, const long long offset,
...
struct offset_size_pair query_utf_data(FILE *infile, const long long offset,
