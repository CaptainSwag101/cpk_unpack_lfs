...
struct utf_query_result analyze_utf(FILE *infile, const long long offset, int indent,
        int print, const struct utf_query *query);

struct utf_query_result query_utf(FILE *infile, const long long offset,
        const struct utf_query *query);

struct utf_query_result query_utf_nofail(FILE *infile, const long long offset,
        const struct utf_query *query);

struct utf_query_result query_utf_key(FILE *infile, const long long offset,
        int index, const char *name);

uint64_t query_utf_8byte(FILE *infile, const long long offset,
        int index, const char *name);

uint32_t query_utf_4byte(FILE *infile, const long long offset,
        int index, const char *name);

uint16_t query_utf_2byte(FILE *infile, const long long offset,
        int index, const char *name);
